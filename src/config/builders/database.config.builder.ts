...
export class DatabaseConfigBuilder {
    ...
    public build(): IDatabaseConfig {
        ...
        const dbMode = EnvLoader.getString('DB_MODE', 'split') as 'split' | 'single';
        ...
        return {
            ...
            defaultDb,
            dbMode: dbMode === 'single' ? 'single' : 'split',
        };
    }
    ...
    private loadSqliteConfig(): ISqliteConfig | null {
        ...
        return {
            filename,
            client: EnvLoader.getString('SQLITE_CLIENT', 'better-sqlite3') || 'better-sqlite3',

/**
 * @file src/models/mongo/schemas/OTP.schema.ts
 * @description Mongoose schema for OTPs (without model registration)
 */
...
export const OTPSchema = new Schema<IOtpMongoDocument>(
    {
